      ...
      <section className="bg-gradient-to-br from-law-navy via-law-navy-dark to-gray-900 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            Our Legal
            <span className="block text-law-gold">Services</span>
          </h1>
          ...
          <Card className="border-0 shadow-xl">
            ...
            <CardContent className="pb-8">
              <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
                We're currently building a comprehensive overview of our legal
                services. This page will feature detailed information about our
                practice areas including Corporate Law, Real Estate Law, Family
                Law, Criminal Defense, and more.
              </p>
